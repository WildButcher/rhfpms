...
<html>
    ...
    <script>
        function changeYear(){
            ...
            var url = '/index.php/Admin/Index/index/c_date/' + year;
            window.location.href = url;
        }

        function viewContractList(f,c){
            var url = '/index.php/Admin/Contract/mobileView';
                    ...
                    <div class="row">
                        <div class="col-xs-12">
                            <div class="box">
                                ...
                                <form method="post" action="/index.php/Admin/Moulds/mouldsViewList">
                            ...
                            <div class="box">
                                <div class="box-body table-responsive">
                                    <table id="example2" class="table table-bordered table-hover text-left">
                                        <thead>
                                        <tr>
                                            <th class="col-xs-2 text-center">原料库存</th>
                                            <th class="col-xs-10 text-center"></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                            <td class="text-center">天然胶</td>
                                            <td class="text-left">数值</td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">丁晴胶</td>
                                            <td class="text-left">数值</td>
                                        </tr>
                                        </tbody>
                                    </table>
                            ...
                            <div class="box">
                                <div class="box-body table-responsive">
                                    <table id="example2" class="table table-bordered table-hover text-left">
                                        <thead>
                                        <tr>
                                            <th class="col-xs-2 text-center">职工情况</th>
                                            <th class="col-xs-10 text-center"></th>
                                        </tr>
                                        </thead>
                                        <tbody>
                                        <tr>
                                            <td class="text-center">职工总人数</td>
                                            <td class="text-left">【 <?php echo ($employees); ?> 】人</td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">女职工</td>
                                            <td class="text-left">【 <?php echo ($e_gender); ?> 】人</td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">签订劳动合同</td>
                                            <td class="text-left">【 <?php echo ($e_contract); ?> 】人</td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">退休返聘</td>
                                            <td class="text-left">【 <?php echo ($e_retird); ?> 】人</td>
                                        </tr>
                                        <tr>
                                            <td class="text-center">双重关系</td>
                                            <td class="text-left">【 <?php echo ($e_double); ?> 】人</td>
                                        </tr>
                                        </tbody>
                                    </table>
                                </div>
