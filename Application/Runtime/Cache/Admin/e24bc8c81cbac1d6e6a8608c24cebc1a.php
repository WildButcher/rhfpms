            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive">
                        <form role="form" action="/index.php/Admin/Employee/recordInsert" method="post" name="form1">
                            <!-- text input -->
                            <div class="form-group">
                                <label>职工名称</label>
                                <input type="text" id="e_name" name="e_name" class="form-control" placeholder="请选择..." />
                            </div>
                            <div class="form-group">
                                <label>性别</label><br/>
                            ...
                            <div class="form-group">
                                <label>联系电话</label>
                                <input type="text" name="e_moblie" class="form-control" placeholder="请输入..." />
                            </div>
                            <div class="form-group">
                                <label>薪酬</label>
                                <input type="text" name="e_pay" class="form-control" placeholder="请输入..." />
                            </div>
                            <div class="form-group">
                                <label>职工状态</label>
