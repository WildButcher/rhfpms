...
<script language="javascript">
    ...
    function changeStatus(obj){
        var str = "/index.php/Admin/Employee/recordChange/status/" + obj;
    ...
    function relationPriceBill(){
        var str = "/index.php/Admin/Employee/relationShow";
        $("#formContractList").attr("action", str);
        $("#formContractList").submit();
    }
    /*
    ...
    function exportExcel(){
        var str = "/index.php/Admin/Employee/toExcel";
        $("#formContractList").attr("action", str);
        $("#formContractList").submit();
    }
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive">
                        <button class="btn btn-app btn-sm" onclick="location='/index.php/Admin/Employee/recordNew'">新增</button>
                        <table id="example2" class="table table-bordered table-hover text-left">
                            ...
                            <?php if(is_array($employees)): $i = 0; $__LIST__ = $employees;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$employee): $mod = ($i % 2 );++$i;?><tr>
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-danger btn-sm" onclick="location='/index.php/Admin/Employee/recordDelete/id/<?php echo ($employee["id"]); ?>'"><i class="fa fa-times"></i></button>
                                        <button class="btn btn-success btn-sm" onclick="location='/index.php/Admin/Employee/recordShow/id/<?php echo ($employee["id"]); ?>'"><i class="fa fa-edit"></i></button>
                                    </td>
