                    ...
                    <div class="row">
                        <div class="col-xs-3">
                            <div class="box">
                                <script>
                                    var d = new dTree('d');
                                    d.add(0,-1,'客户厂家','/index.php/Admin/Moulds/Index/cid/-1');
                                </script>
                                <?php if(is_array($customers)): $i = 0; $__LIST__ = $customers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$customer): $mod = ($i % 2 );++$i;?><script>
                                        d.add('<?php echo ($customer["id"]); ?>',0,'<?php echo ($customer["c_name"]); ?>','/index.php/Admin/Moulds/Index/cid/<?php echo ($customer["id"]); ?>');
                        ...
                        <div class="col-xs-9">
                            <div class="box">
                                <div class="box-body table-responsive">
                                    <button class="btn btn-app btn-sm" onclick="location='/index.php/Admin/Moulds/mouldsAdd/cid/<?php echo ($cid); ?>'">新增</button>
                                    <button class="btn btn-app btn-sm" onclick="location='/index.php/Admin/Moulds/toExcel'">导出</button>
                                    <h4>
                                    ...
                                    <table id="example2" class="table table-bordered table-hover text-center">
                                        ...
                                        <?php if(is_array($moulds)): $i = 0; $__LIST__ = $moulds;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$mould): $mod = ($i % 2 );++$i;?><tr>
                                            <td>
                                                <button class="btn btn-danger btn-sm" onclick="location='/index.php/Admin/Moulds/mouldsDel/i/<?php echo ($mould["id"]); ?>/cid/<?php echo ($cid); ?>'"><i class="fa fa-times"></i></button>
                                                <button class="btn btn-success btn-sm" onclick="location='/index.php/Admin/Moulds/mouldsShow/i/<?php echo ($mould["id"]); ?>/cid/<?php echo ($cid); ?>'"><i class="fa fa-edit"></i></button>
                                            </td>
                                            <td><?php echo ($i); ?></td>
