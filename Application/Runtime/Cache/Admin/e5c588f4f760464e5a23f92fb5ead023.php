...
<script language="javascript">
    ...
    function changeStatus(obj){
        var str = "/index.php/Admin/Contract/recordChange/status/" + obj;
    ...
    function relationPriceBill(){
        var str = "/index.php/Admin/Contract/relationShow";
        $("#formContractList").attr("action", str);
        $("#formContractList").submit();
    }
    /*
    ...
    function exportExcel(){
        var str = "/index.php/Admin/Contract/toExcel";
        $("#formContractList").attr("action", str);
        $("#formContractList").submit();
    }
            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive">
                        <button class="btn btn-app btn-sm" onclick="location='/index.php/Admin/Contract/recordNew'">新增</button>
                        ...
                        <form method="post" action="/index.php/Admin/Contract/recordSearch" role="form" id="formContractList">
                        ...
                        <table id="example2" class="table table-bordered table-hover text-left">
                            ...
                            <?php if(is_array($contracts)): $i = 0; $__LIST__ = $contracts;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$contract): $mod = ($i % 2 );++$i;?><tr>
                                    <td class="text-center">
                                        ...
                                        <button class="btn btn-danger btn-sm" onclick="location='/index.php/Admin/Contract/recordDelete/id/<?php echo ($contract["id"]); ?>'"><i class="fa fa-times"></i></button>
                                        <button class="btn btn-success btn-sm" onclick="location='/index.php/Admin/Contract/recordShow/id/<?php echo ($contract["id"]); ?>'"><i class="fa fa-edit"></i></button>
                                        <button class="btn btn-facebook btn-sm" onclick="location='/index.php/Admin/ContractPlus/Index/id/<?php echo ($contract["id"]); ?>'"><i class="fa fa-plus-square"></i></button>
                                    </td>
