            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive">
                        <button class="btn btn-app btn-sm" onclick="location='/admin/goods/recordNew'">新增</button>
                        <!--
                        <button class="btn btn-app btn-sm" onclick="location='/admin/goods/impFromMoulds'">从模具导入</button>
                        -->
                        <button class="btn btn-app btn-sm" onclick="">导出</button>
                        <form method="post" action="/admin/goods/recordSearch" role="form" name="p_search">
                        ...
                        <table id="example2" class="table table-bordered table-hover text-left">
                            ...
                            <?php if(is_array($goodses)): $i = 0; $__LIST__ = $goodses;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><tr>
                                    <td class="text-center">
                                        <button class="btn btn-danger btn-sm" onclick="location='/admin/goods/recordDelete/id/<?php echo ($goods["id"]); ?>'"><i class="fa fa-times"></i></button>
                                        <button class="btn btn-success btn-sm" onclick="location='/admin/goods/recordShow/id/<?php echo ($goods["id"]); ?>'"><i class="fa fa-edit"></i></button>
                                    </td>
