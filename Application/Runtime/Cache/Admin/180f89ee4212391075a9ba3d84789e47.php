            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive">
                        <button class="btn btn-app btn-sm" onclick="location='/index.php/Admin/Goods/recordNew'">新增</button>
                        <!--
                        <button class="btn btn-app btn-sm" onclick="location='/index.php/Admin/Goods/impFromMoulds'">从模具导入</button>
                        -->
                        <button class="btn btn-app btn-sm" onclick="">导出</button>
                        <form method="post" action="/index.php/Admin/Goods/recordSearch" role="form" name="p_search">
                            <input type="text" name="p_guige" class="form-control" placeholder="请输入查找的规格...">
                        ...
                        <table id="example2" class="table table-bordered table-hover text-left">
                            ...
                            <tr>
                                ...
                                <th class="text-center">产品价格（元）</th>
                                <th class="text-center">产品重量（kg）</th>
                                <th class="text-center">产品原料</th>
                            </tr>
                            </thead>
                            <tbody>
                            <?php if(is_array($goodses)): $i = 0; $__LIST__ = $goodses;if( count($__LIST__)==0 ) : echo "暂时没有数据" ;else: foreach($__LIST__ as $key=>$goods): $mod = ($i % 2 );++$i;?><tr>
                                    <td class="text-center">
                                        <button class="btn btn-danger btn-sm" onclick="location='/index.php/Admin/Goods/recordDelete/id/<?php echo ($goods["id"]); ?>'"><i class="fa fa-times"></i></button>
                                        <button class="btn btn-success btn-sm" onclick="location='/index.php/Admin/Goods/recordShow/id/<?php echo ($goods["id"]); ?>'"><i class="fa fa-edit"></i></button>
                                    </td>
                                    <td class="text-center"><?php echo ($i); ?></td>
                                    <td><?php echo ($goods["p_name"]); ?></td>
                                    <td><?php echo ($goods["p_guige"]); ?></td>
                                    <td><?php echo ($goods["p_price"]); ?></td>
                                    <td><?php echo ($goods["p_weight"]); ?></td>
                                    <td><?php echo ($goods["p_raw"]); ?></td>
