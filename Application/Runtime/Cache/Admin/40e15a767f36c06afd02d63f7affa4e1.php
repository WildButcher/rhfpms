                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-body table-responsive">
                                    <button class="btn btn-app btn-sm" onclick="location='/index.php/Admin/User/recordNew'">新增</button>
                                    <table id="example2" class="table table-bordered table-hover text-left">
                                        ...
                                        <?php if(is_array($users)): $i = 0; $__LIST__ = $users;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$user): $mod = ($i % 2 );++$i;?><tr>
                                                <td class="text-center">
                                                    <button class="btn btn-danger btn-sm" onclick="location='/index.php/Admin/User/recordDelete/id/<?php echo ($user["id"]); ?>'"><i class="fa fa-times"></i></button>
                                                    <button class="btn btn-success btn-sm" onclick="location='/index.php/Admin/User/recordShow/id/<?php echo ($user["id"]); ?>'"><i class="fa fa-edit"></i></button>
                                                </td>
