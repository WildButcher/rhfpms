            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive">
                        <form role="form" action="/index.php/Admin/Employee/recordUpdate" method="post" name="form1">
                            <!-- text input -->
                            <div class="form-group">
                                <label>职工名称</label>
                                <input type="hidden" id="id" name="id" value="<?php echo ($employee["id"]); ?>"/>
                                <input type="text" id="e_name" name="e_name" class="form-control" placeholder="请选择..." value="<?php echo ($employee["e_name"]); ?>">
                            </div>
                            <div class="form-group">
                                <label>性别</label><br/>
                                <select name="e_gender" class="form-control">
                                    <option value="<?php echo ($employee["e_gender"]); ?>"><?php echo ($employee["e_gender"]); ?></option>
                            ...
                            <div class="form-group">
                                <label>联系电话</label>
                                <input type="text" name="e_moblie" class="form-control" placeholder="请输入..." value="<?php echo ($employee["e_moblie"]); ?>">
                            </div>
                            <div class="form-group">
                                <label>薪酬</label>
                                <input type="text" name="e_pay" class="form-control" placeholder="请输入..." value="<?php echo ($employee["e_pay"]); ?>"/>
                            </div>
                            <div class="form-group">
                                <label>职工状态</label>
                                <select name="e_status" class="form-control">
                                    <option value="<?php echo ($employee["e_status"]); ?>"><?php echo ($employee["e_status"]); ?></option>
                                    <option value="在职">在职</option>
                                    <option value="退休返聘">退休返聘</option>
                                    <option value="双重关系">双重关系</option>
                                </select>
                            </div>
                            <div class="form-group">
