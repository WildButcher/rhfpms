                        ...
                        <div class="col-xs-12">
                            <div class="box">
                                <div class="box-body table-responsive">
                                    <button class="btn btn-app btn-sm" onclick="location='/admin/customer/recordNew'">新增</button>
                                    <button class="btn btn-app btn-sm" onclick="">导出</button>
                                    <form method="post" action="/admin/customer/recordSearch" role="form" name="c_search">
                                    ...
                                    <table id="example2" class="table table-bordered table-hover text-left">
                                        ...
                                        <?php if(is_array($customers)): $i = 0; $__LIST__ = $customers;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$customer): $mod = ($i % 2 );++$i;?><tr>
                                            <td class="text-center">
                                                <button class="btn btn-danger btn-sm" onclick="location='/admin/customer/recordDelete/id/<?php echo ($customer["id"]); ?>'"><i class="fa fa-times"></i></button>
                                                <button class="btn btn-success btn-sm" onclick="location='/admin/customer/recordShow/id/<?php echo ($customer["id"]); ?>'"><i class="fa fa-edit"></i></button>
                                            </td>
