            ...
            <div class="col-xs-12">
                <div class="box">
                    <div class="box-body table-responsive">
                        <button class="btn btn-app btn-sm" onclick="location='/index.php/Admin/Contract'">返回</button>
                        <button class="btn btn-app btn-sm" onclick="location='/index.php/Admin/ContractPlus/recordNew/cid/<?php echo ($cid); ?>'">新增</button>
                        <input type="hidden" id="cid" name="<?php echo ($cid); ?>"/>
                        <table id="example2" class="table table-bordered table-hover text-left">
                            ...
                            <tbody>
                            <?php if(is_array($contract_pluses)): $i = 0; $__LIST__ = $contract_pluses;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$contract_plus): $mod = ($i % 2 );++$i;?><tr>
                                    <td class="text-center">
                                        <button class="btn btn-danger btn-sm" onclick="location='/index.php/Admin/ContractPlus/recordDelete/id/<?php echo ($contract_plus["id"]); ?>/cid/<?php echo ($cid); ?>'"><i class="fa fa-times"></i></button>
                                    </td>
                                    <td><?php echo ($contract_plus["c_name"]); ?></td>
                                    <td><?php echo ($contract_plus["c_guige"]); ?></td>
                                    <td><?php echo ($contract_plus["c_type"]); ?></td>
                                    <td><?php echo ($contract_plus["c_price"]); ?></td>
                                    <td><?php echo ($contract_plus["c_number"]); ?></td>
                                    <td><?php echo ($contract_plus["c_total"]); ?></td>
